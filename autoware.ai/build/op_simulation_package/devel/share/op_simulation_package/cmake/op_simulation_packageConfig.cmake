...
if(NOT "/home/chinchia120/autoware.ai/src/autoware/core_planning/op_simulation_package/include " STREQUAL " ")
  set(op_simulation_package_INCLUDE_DIRS "")
  set(_include_dirs "/home/chinchia120/autoware.ai/src/autoware/core_planning/op_simulation_package/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'op_simulation_package' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/chinchia120/autoware.ai/src/autoware/core_planning/op_simulation_package/${idir}'.  ${_report}")
    endif()
