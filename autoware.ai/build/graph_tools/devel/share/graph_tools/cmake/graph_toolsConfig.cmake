...
if("TRUE" STREQUAL "TRUE")
  set(graph_tools_SOURCE_PREFIX /home/chinchia120/autoware.ai/src/autoware/utilities/graph_tools)
  set(graph_tools_DEVEL_PREFIX /home/chinchia120/autoware.ai/build/graph_tools/devel)
  ...
  set(graph_tools_INSTALL_PREFIX /home/chinchia120/autoware.ai/install/graph_tools)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'graph_tools' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/chinchia120/autoware.ai/src/autoware/utilities/graph_tools/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/chinchia120/autoware.ai/build/graph_tools/devel/lib;/home/chinchia120/catkin_ws/devel/lib;/opt/ros/melodic/lib)
