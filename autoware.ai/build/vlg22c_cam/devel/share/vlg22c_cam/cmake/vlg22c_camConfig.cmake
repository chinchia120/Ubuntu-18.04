...
if("TRUE" STREQUAL "TRUE")
  set(vlg22c_cam_SOURCE_PREFIX /home/chinchia120/autoware.ai/src/drivers/awf_drivers/baumer)
  set(vlg22c_cam_DEVEL_PREFIX /home/chinchia120/autoware.ai/build/vlg22c_cam/devel)
  ...
  set(vlg22c_cam_INSTALL_PREFIX /home/chinchia120/autoware.ai/install/vlg22c_cam)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'vlg22c_cam' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/chinchia120/autoware.ai/src/drivers/awf_drivers/baumer/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/chinchia120/autoware.ai/build/vlg22c_cam/devel/lib;/home/chinchia120/autoware.ai/install/autoware_build_flags/lib;/home/chinchia120/catkin_ws/devel/lib;/opt/ros/melodic/lib)
