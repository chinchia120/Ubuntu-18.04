...
if("TRUE" STREQUAL "TRUE")
  set(kitti_launch_SOURCE_PREFIX /home/chinchia120/autoware.ai/src/autoware/utilities/kitti_launch)
  set(kitti_launch_DEVEL_PREFIX /home/chinchia120/autoware.ai/build/kitti_launch/devel)
  ...
  set(kitti_launch_INSTALL_PREFIX /home/chinchia120/autoware.ai/install/kitti_launch)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'kitti_launch' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/chinchia120/autoware.ai/src/autoware/utilities/kitti_launch/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/chinchia120/autoware.ai/build/kitti_launch/devel/lib;/home/chinchia120/autoware.ai/install/kitti_player/lib;/home/chinchia120/autoware.ai/install/kitti_box_publisher/lib;/home/chinchia120/autoware.ai/install/autoware_msgs/lib;/home/chinchia120/catkin_ws/devel/lib;/opt/ros/melodic/lib)
