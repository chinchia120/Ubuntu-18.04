...
(cl:defmethod cl:initialize-instance :after ((m <my_srv-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'my_srv-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name beginner_tutorials-srv:<my_srv-request> is deprecated: use beginner_tutorials-srv:my_srv-request instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<my_srv-request>)))
  ...
  "beginner_tutorials/my_srvRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'my_srv-request)))
  "Returns string type for a service object of type 'my_srv-request"
  "beginner_tutorials/my_srvRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <my_srv-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'my_srv-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name beginner_tutorials-srv:<my_srv-response> is deprecated: use beginner_tutorials-srv:my_srv-response instead.")))
...
(cl:defmethod gender-val ((m <my_srv-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader beginner_tutorials-srv:gender-val is deprecated.  Use beginner_tutorials-srv:gender instead.")
  (gender m))

(cl:ensure-generic-function 'age-val :lambda-list '(m))
(cl:defmethod age-val ((m <my_srv-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader beginner_tutorials-srv:age-val is deprecated.  Use beginner_tutorials-srv:age instead.")
  (age m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<my_srv-response>)))
  ...
  "beginner_tutorials/my_srvResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'my_srv-response)))
  "Returns string type for a service object of type 'my_srv-response"
  "beginner_tutorials/my_srvResponse")
